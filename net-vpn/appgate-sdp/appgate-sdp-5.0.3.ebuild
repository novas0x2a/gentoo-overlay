EAPI=7
inherit unpacker systemd xdg-utils
...
QA_PREBUILT="
	/opt/appgate/AppGate
	/opt/appgate/chrome-sandbox
	/opt/appgate/libEGL.so
	/opt/appgate/libGLESv2.so
	/opt/appgate/libffmpeg.so
	...
	/opt/appgate/service/libfido2.so
	...
	/opt/appgate/swiftshader/libEGL.so
	/opt/appgate/swiftshader/libGLESv2.so
	/opt/appgate/tun-service
"

src_install() {
	gunzip usr/share/doc/appgate/changelog.gz || die
	gunzip usr/share/man/man5/appgate.conf.5.gz || die

	dodoc usr/share/doc/appgate/changelog
	dodoc usr/share/doc/appgate/firejail/appgate.profile
	domenu usr/share/applications/appgate.desktop
	doicon usr/share/icons/hicolor/scalable/apps/appgate-icon.svg
