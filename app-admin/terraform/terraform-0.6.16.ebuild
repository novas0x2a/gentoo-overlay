...
COMMON_IUSE="chef"
IUSE_PROVIDERS="atlas aws azure azurerm clc cloudflare cloudstack cobbler consul datadog digitalocean dme dnsimple docker dyn fastly github google heroku influxdb librato mailgun mysql +null openstack packet postgresql powerdns rundeck softlayer statuscake +template +tls triton ultradns vcd vsphere"
