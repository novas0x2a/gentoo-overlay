...
# $Header: /var/cvsroot/gentoo-x86/dev-python/ipython/ipython-0.10.ebuild,v 1.8 2009/11/03 17:20:09 armin76 Exp $
...
src_prepare() {
	...
	find . -name '*\.py' -print0 | xargs -0 grep /usr/bin/python | cut -d : -f 1 | xargs sed -i -e's#/usr/bin/python#/usr/bin/env python#g'
	sed -i \
