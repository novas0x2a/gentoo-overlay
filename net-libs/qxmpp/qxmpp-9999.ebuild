...
if use hipchat; then
	EGIT_REPO_URI="https://bitbucket.org/hipchat/qxmpp.git"
	EGIT_BRANCH="hipchat-auth-update"
	# 7935ab7626e1142512ddd99d4bb6a60123f98dd5 requires a method that doesn't exist in qt yet?
	EGIT_COMMIT="1730bf2855d985ca0b92d521c3b851cdd0b93e8f"
else
...
SLOT="0"
KEYWORDS=""
IUSE="debug doc +speex test theora vpx hipchat"
